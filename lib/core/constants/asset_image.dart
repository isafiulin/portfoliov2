class AssetImageConstant {
  ...
  static const indenimcrm = "${_projectsImages}indenimcrm.png";
  static const mamaspace = "${_projectsImages}mamaspace.png";
  static const indenimpda = "${_projectsImages}indenimpda.png";
